...
{/* Check to see if there are flashcards in deck */}
    { (this.props.props.amountOfCards <= 0)
            ...
            : (
        <StyleRoot>
        <div className="card-container" style={styles.fadeInRight}>
